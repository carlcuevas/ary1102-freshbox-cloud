...
// Todas las peticiones usan rutas relativas: el propio nginx del contenedor
// frontend hace de reverse proxy hacia los 4 microservicios backend segun
// metodo HTTP (ver nginx.conf). Esto permite que el flujo funcione tanto en
// local (docker compose) como detras del ALB en AWS, que solo expone el
// puerto 80/443 hacia las EC2 de la capa App.
const API_PRODUCTS = '/api/products';
const API_GET = API_PRODUCTS;
const API_POST = API_PRODUCTS;
const API_PUT = API_PRODUCTS;
const API_DELETE = API_PRODUCTS;
